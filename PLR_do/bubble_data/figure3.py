...
#读取数据
datafile = u'C:\\Users\\miaosilin\\Desktop\\Population_land_realestate\\PLR_do\\bubble_data\\bubble_data3.xlsx'
data = pd.read_excel(datafile)
 
plt.figure(figsize=(10,5))#设置画布的尺寸
plt.title('Guanzhong Plain Urban Agglomeration')
...
plt.savefig('bubble3.pdf',dpi=600,format='pdf')
plt.savefig('bubble3.jpg',dpi=600,format='jpg')
plt.show()#显示图像
