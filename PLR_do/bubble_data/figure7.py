...
#读取数据
datafile = u'C:\\Users\\miaosilin\\Desktop\\Population_land_realestate\\PLR_do\\bubble_data\\bubble_data7.xlsx'
data = pd.read_excel(datafile)
 
plt.figure(figsize=(10,5))#设置画布的尺寸
plt.title('the Pearl River Delta Urban Agglomerations')
...
plt.savefig('bubble7.pdf',dpi=600,format='pdf')
plt.savefig('bubble7.jpg',dpi=600,format='jpg')
plt.show()#显示图像
