...
datafile2 = u'CouplingCR1.xlsx'
data2 = pd.read_excel(datafile2)
datafile3 = u'CouplingCR2.xlsx'
data3 = pd.read_excel(datafile3)
datafile4 = u'CouplingCR3.xlsx'
data4 = pd.read_excel(datafile4)
datafile5 = u'CouplingCR4.xlsx'
...
ax.set_ylabel('Spatial Coupling Degree',fontsize='8')
...
ax2.set_ylim([0,1])
ax2.set_ylabel('Coupling Concerntration Rate',fontsize='8')
...
plt.savefig('bar1.pdf',dpi=600,format='pdf')
plt.savefig('bar1.jpg',dpi=600,format='jpg')
plt.show()#显示图像
