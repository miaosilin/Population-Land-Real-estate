...
datafile2 = u'CouplingCoordinationCR1.xlsx'
data2 = pd.read_excel(datafile2)
datafile3 = u'CouplingCoordinationCR2.xlsx'
data3 = pd.read_excel(datafile3)
datafile4 = u'CouplingCoordinationCR3.xlsx'
data4 = pd.read_excel(datafile4)
datafile5 = u'CouplingCoordinationCR4.xlsx'
...
ax.set_ylabel('Spacial Coupling Coordination Degree',fontsize='8')
...
ax2.set_ylim([0,1])
ax2.set_ylabel('Coupling Coordination Concerntration Rate',fontsize='8')
...
plt.savefig('bar3.pdf',dpi=600,format='pdf')
plt.savefig('bar3.jpg',dpi=600,format='jpg')
plt.show()#显示图像
